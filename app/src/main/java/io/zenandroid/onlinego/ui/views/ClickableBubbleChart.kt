...
class ClickableBubbleChart : BubbleChart {
	...
	override fun onTouchEvent(event: MotionEvent): Boolean {
		...
		val markerView = this.getMarker() as? ClickableMarkerView
        if (markerView != null && isDrawMarkersEnabled() && valuesToHighlight()) {
            val rect = Rect(markerView.drawingPosX.toInt(), markerView.drawingPosY.toInt(), markerView.drawingPosX.toInt() + markerView.getWidth().toInt(), markerView.drawingPosY.toInt() + markerView.getHeight().toInt())
